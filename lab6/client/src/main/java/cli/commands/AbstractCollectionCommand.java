...
public abstract class AbstractCollectionCommand extends AbstractCommand {
     ...
     */
    public AbstractCollectionCommand(String name, String description, ArrayList<String> inlineParams, AbstractManager manager) {
        super(name, description, inlineParams);
